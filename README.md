...
# 🛠️ What I'm Experimenting With
 ...
 - JSON Data Configurations: Playing around with JSON files (vulpix.json) to store all the character data—like names, stats, levels, and moves.
...
vgame/
  ...
  └── vulpix.json      # The JSON file holding our character's stats and moves
```
